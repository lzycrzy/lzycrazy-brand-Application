...
import com.example.lzycrazy.withlogin.raahimPost.PostFragment
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bottomView.setOnItemSelectedListener {
            ...
            when (it.itemId) {
                ...
                R.id.nav_post -> replaceWithFragment(PostFragment())
                R.id.nav_market -> replaceWithFragment(AlertsFragment())
                R.id.nav_profile -> replaceWithFragment(AboutFragment())
            }
            true
        }
    }
