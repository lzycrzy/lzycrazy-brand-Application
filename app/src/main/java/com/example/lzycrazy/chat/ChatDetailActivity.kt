...
import com.example.lzycrazy.message.Message
import com.example.lzycrazy.message.MessageAdapter
        ...
        btnSend.setOnClickListener {
            ...
            if (text.isNotEmpty()) {
                ...
                recyclerChat.postDelayed({
                    val replyTime = java.text.SimpleDateFormat("hh:mm a", java.util.Locale.getDefault())
                        .format(java.util.Date())
